...
class CommercialLoan
{
    ...
    double MainteneceCost = 0.95;  //To cover land maintenece cost for *property loan
    double FeesCost = 0.975; //To cover mailing/transaction fees for a loan used to pay *bills
    double HiringCost = 0.925; //To cover the cost of the hiring process on a loan for new *staff
    double InsuranceCost = 0.9; //To cover insurance on a loan for new *equipment
