...
public class Main {
    ...
    BankAccount vito = new BankAccount();
    Customer vito1 = new Customer();
    ATM vito2 = new ATM();
    EmployeeTeam vito4 = new EmployeeTeam();
    Investment vito5 = new Investment();
    LoanDeptTest vito6 = new LoanDeptTest();
    safeDeposit vito7 = new safeDeposit(); 
    CommercialLoan vito8 = new CommercialLoan();
