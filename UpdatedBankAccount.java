...

{
        ...
        myName = vito1.getmyName; 

        myAddress = vito1.getmyAddress;

        myBirthday = vito1.getmyBirthday;

        cardNumber = vito1.getcardNumber;

        pin = vito1.getpin;

        accountName = vito1.getaccountName;

        myPassword = vito1.getmyPassword;
